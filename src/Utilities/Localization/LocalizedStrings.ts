...
export default class LocalizedStrings {
  ...
  static SmsText = () => I18manager.strings('sms_text');
  ...
  static ScanNow = () => I18manager.strings('ScanNow');
  static ScanHistory = () => I18manager.strings('ScanHistory');

  // Dashboard Screen
  static ViewNow = () => I18manager.strings('ViewNow');
  static AddNewCrop = () => I18manager.strings('AddNewCrop');
  static AddEnrollCropSubTitle = () =>
    I18manager.strings('AddEnrollCropSubTitle');
  static ThereAreNTasksPending = (reminder) =>
    I18n.t('ThereAreNTasksPending', { reminder });
  static ThereIsOneTaskPending = () =>
    I18manager.strings('ThereIsOneTaskPending');
  static NoTasksPending = () => I18manager.strings('NoTasksPending');

  // Wether Screen
  static HourlyForecast = () => I18manager.strings('HourlyForecast');
  static Time = () => I18manager.strings('Time');
  static Climate = () => I18manager.strings('Climate');
  static TempKey = () => I18manager.strings('TempKey');
  static Rainfall = () => I18manager.strings('Rainfall');
  static for_24_hours = () => I18manager.strings('for_24_hours');
  static Sunny = () => I18manager.strings('Sunny');
  static Cloudy = () => I18manager.strings('Cloudy');
  static Hail = () => I18manager.strings('Hail');
  static Windy = () => I18manager.strings('Windy');
  static Rainy = () => I18manager.strings('Rainy');
  static SevenDayForecast = () => I18manager.strings('SevenDayForecast');
  static WeekExtremeRain = () => I18manager.strings('WeekExtremeRain');
  static CurrentWeather = () => I18manager.strings('CurrentWeather');
  static BestTimeSpray = () => I18manager.strings('BestTimeSpray');
  static PossibilitySpray = () => I18manager.strings('PossibilitySpray');
  static High = () => I18manager.strings('High');
  static SeedSpecification = () => I18manager.strings('SeedSpecification');
  static MoreInformation = () => I18manager.strings('MoreInformation');
  static TechInformation = () => I18manager.strings('TechInformation');
  static EffectiveAgainstDiseases = () =>
    I18manager.strings('EffectiveAgainstDiseases');
  static ProductDetailsTitle = () => I18manager.strings('ProductDetailsTitle');
  static NextSprayIs = () => I18manager.strings('NextSprayIs');
  static to = () => I18manager.strings('to');
  // Weather End

  // My Crops Screen
  static Seeds = () => I18manager.strings('Seeds');
  static selectCropToViewSeeds = () =>
    I18manager.strings('selectCropToViewSeeds');
  static cropNotAvailable = () => I18manager.strings('cropNotAvailable');
  static noSuchCrop = () => I18manager.strings('noSuchCrop');
  static couldnotFindSearch = () => I18manager.strings('couldnotFindSearch');
  static RecommendedCrop = () => I18manager.strings('RecommendedCrop');

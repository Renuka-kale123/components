...
export const colors = {
  ...
  iguanaGreen: '#70B687',
  themeDefaultColor: '#C6E6FF',
  themeSunnyColor: '#FAE8BE',
  themeRainyColor: '#E7E0F4',
  themeWindyColor: '#CAE9E9',
  themeCloudyColor: '#B8D3F9',
  themeTranparentColor: '#ffffff00',
  themeCommonColor: '#FDFEFF',
  whiteIce: '#E0F9F7',
  charade: '#292B38',
  toottipGray: '#636874',
  borderGreyColor: '#DFE1E8',
  lightBlueBackground: '#F1FEFF',
  cyanblue: '#0077B6',
  gray85: '#D9D9D980',
  teal80: '#0D413C',
  themeCommonColorOpacity: '#FDFEFF80',
  Cornsilk: '#fff3dd80',
  LightCyan: '#f6fdfd',
  lightRed: '#FEFDFD',
  searchGrey: '#A1A8B8',
